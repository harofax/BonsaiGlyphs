...
namespace BonsaiGlyphs.Code.Debug;
...
public class DebugWindow : Window
{
    ...
    public DebugWindow(int width, int height, int historyLength = 1000) : base(width, height)
    {
        ...
        //this.GetSubSurface().DefaultBackground = Color.AnsiBlue;
        this.Surface.DefaultBackground = Color.AnsiBlue;
    ...
    {
        _log.Surface.View = new Rectangle(0, _scrollBar.Value, _log.Width, _log.ViewHeight);
    }
    ...
    public override void Update(TimeSpan delta)
    {
        ...
        if (_log.Surface.TimesShiftedUp != 0 | _log.Cursor.Position.Y >= _log.ViewHeight + ScrollOffset)
        {
            ...
            if (ScrollOffset < _log.Height - _log.ViewHeight)
            {
                ...
                ScrollOffset += _log.Surface.TimesShiftedUp != 0 ? _log.Surface.TimesShiftedUp : 1;
            }
